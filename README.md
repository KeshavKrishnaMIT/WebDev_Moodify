...
Letting users select their current mood

Showing relevant activity suggestions for that mood

Keeping the experience simple, aesthetic, and distraction-free
...
CSS3 – layout, gradients, responsiveness, and animations

JavaScript (Vanilla) – mood logic and dynamic content

Google Firebase Hosting – live deployment
...
How real projects go from local → live

Using Firebase CLI for deployment

Linking GitHub workflow with production-ready code
...
Making layouts responsive for mobile devices

Debugging real UI interaction issues

Hosting and maintaining a live website

Confidence to build and deploy future projects
...
My transition from learning concepts → building real things

My first successful cloud deployment

A solid foundation for bigger and more advanced projects ahead

This is not just a project — it’s a starting point.
